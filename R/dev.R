...
#'
#' @param ukb_data_dict data frame created by \code{make_data_dict}
#'
#' @return data frame
#' @noRd
function(ukb_data_dict) {
  ...
  ukb_data_dict$cont_int_to_na <- dplyr::case_when(
    # CONVERT TO NA
    ukb_data_dict$Coding %in% CONT_AND_INT_CODINGS_TO_NA ~ TRUE,

    # DO *NOT* CONVERT TO NA
    ukb_data_dict$Coding %in% CONT_AND_INT_CODINGS_NOT_TO_NA ~ FALSE,
    TRUE ~ FALSE
  )
